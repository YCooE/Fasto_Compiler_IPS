...
# was:	sw	_size_reg_19_, 0(_letBind_15_)
	addi	$20, $17, 0
# was:	addi	_ret_reg_23_, _letBind_15_, 0
	sw	$16, 0($20)
# was:	sw	_size_reg_19_, 0(_ret_reg_23_)
	addi	$20, $20, 4
# was:	addi	_ret_reg_23_, _ret_reg_23_, 4
	ori	$19, $0, 0
# was:	ori	_i_reg_18_, 0, 0
_loop_beg_21_:
	sub	$2, $19, $16
# was:	sub	_tmp_reg_20_, _i_reg_18_, _size_reg_19_
	bgez	$2, _loop_end_22_
# was:	bgez	_tmp_reg_20_, _loop_end_22_
	lw	$2, 0($18)
# was:	lw	_tmp_reg_20_, 0(_arr_reg_16_)
	addi	$18, $18, 4
# was:	addi	_arr_reg_16_, _arr_reg_16_, 4
# 	ori	2,_tmp_reg_20_,0
# 	ori	3,_acc_reg_17_,0
	jal	incr
# was:	jal	incr, 2 3
# 	ori	_tmp_reg_24_,2,0
# 	ori	_tmp_reg_20_,_tmp_reg_24_,0
	ori	$3, $2, 0
# was:	ori	_acc_reg_17_, _tmp_reg_20_, 0
	sw	$2, 0($20)
# was:	sw	_tmp_reg_20_, 0(_ret_reg_23_)
	addi	$20, $20, 4
# was:	addi	_ret_reg_23_, _ret_reg_23_, 4
	addi	$19, $19, 1
